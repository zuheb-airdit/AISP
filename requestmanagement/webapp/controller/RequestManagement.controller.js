      ...
      "com.requestmanagement.requestmanagement.controller.RequestManagement",
      {
        ...
        onCreateRquestManagement: function () {
          ...
          oModel.read("/CompanyCode", {
            ...
            error: function (oError) {
              ...
              MessageBox.error(
                "Failed to load company codes. Please try again."
              );
            },
          });
        },
        ...
        onInviteRquestManagement: function () {
          if (!this.vhFragmentReqManagement) {
            this.vhFragmentReqManagement = sap.ui.xmlfragment(
              "com.requestmanagement.requestmanagement.fragments.createRequestManagement",
              this
            );
        ...
        onSumbitReqManagement: function () {
          ...
          reqModel.create("/RequestProcess", payload, {
            success: function (oData) {
              ...
              this.getView()
                .byId("idSmartTableReqManagementInvidted")
                .rebindTable();
        ...
        onValueHelpOkPressRolesVendor: function (oEvent) {
          ...
          if (aSelectedContexts.length) {
            ...
            sap.ui
              .getCore()
              .byId("idVendorTypes")
              .setValue(`${sSelectedKey} - ${sSelectedText}`);
          }
        ...
        onInviteMarketPlace: function () {
          var oEventBus = sap.ui.getCore().getEventBus();
          oEventBus.publish("myChannel", "myEvent", {
            sKey: "30",
            sText: "Supplier Market Place",
            sUrl: "https://airdit-19092023-jb69io75.launchpad.cfapps.ap10.hana.ondemand.com/21cb2290-7da6-4493-bdff-f00c37c94eed.Supplier_Marketplace.comsuppliermarketplace01suppliermarketplace-0.0.1/index.html",
          });
        },
      }
    );
